<?php
    ...
    $sql = "SELECT * FROM tbl_dangky WHERE tendangnhap='" . $taikhoa . "' AND matkhau='" . $matkhau . "'";
    ...
    <div class="container">
        ...
        <div class="overlay">
            <div class="page page_signIn">
               ...
               <a href="/Web_BanDoAnNhanh/dangky.php" style="text-decoration: none;" class="btn btnSign-in">Create new account <i class="bi bi-arrow-right"></i></a>
            </div>
